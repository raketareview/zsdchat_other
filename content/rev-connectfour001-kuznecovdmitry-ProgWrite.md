...
- Мне кажется, класс знает много лишнего. Сечас он среди прочего знает что:
...
- В многопользовательских играх должен быть класс Игрок, который используется для идентификации хода и хранит необходимые для игры данные. Например в данном случае- свою игровую фишку
```
public class Player {
